...
namespace MobileWallet.Desktop.API
{
    ...
    public partial class KycClient
    {
...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public KycClient(System.Net.Http.HttpClient httpClient)
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual System.Threading.Tasks.Task<CreateAppSessionKycResponseModel> Kyc_CreateKycAsync(CreateAppSessionKycRequestModel model)
        {
            return Kyc_CreateKycAsync(model, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<CreateAppSessionKycResponseModel> Kyc_CreateKycAsync(CreateAppSessionKycRequestModel model, System.Threading.CancellationToken cancellationToken)
        {
            if (model == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/v1/Kyc"
                    urlBuilder_.Append("api/v1/Kyc");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CreateAppSessionKycResponseModel>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetAppSessionKycsResponseModel> Kyc_GetKycAsync(string sessionId, string atmId, System.DateTimeOffset? startDate, System.DateTimeOffset? endDate, bool? isHideCount, string search, bool? isDescending, int? page, int? pageSize, string orderBy)
        {
            return Kyc_GetKycAsync(sessionId, atmId, startDate, endDate, isHideCount, search, isDescending, page, pageSize, orderBy, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetAppSessionKycsResponseModel> Kyc_GetKycAsync(string sessionId, string atmId, System.DateTimeOffset? startDate, System.DateTimeOffset? endDate, bool? isHideCount, string search, bool? isDescending, int? page, int? pageSize, string orderBy, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetAppSessionKycsResponseModel>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class CreateAppSessionKycResponseModel
    {

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CreateAppSessionKycRequestModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("issuePlace", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetAppSessionKycsResponseModel
    {
        [Newtonsoft.Json.JsonProperty("data", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AppSessionKycDto> Data { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AppSessionKycDto
    {
